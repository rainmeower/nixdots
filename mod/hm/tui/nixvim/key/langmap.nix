{
  programs.nixvim = {
    extraConfigLua = /* lua */ ''
      ...
      local en       = [[qwfrtuiopahgdjkczlebnmvysx]]
      local ru       = [[qcfbdpnklsoghaeizuwtm-ryjv]]
      local en_shift = [[QWFRTUIOPAHGDJKCZLEBNVYSX]]
      local ru_shift = [[QCFBDPNKLSOGHAEIZUWTMRYJV]]
